...
// Replace proof-of-work, proof-of-work, {{DEPS}} with actuals
= proof-of-work — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining proof-of-work for
...
| `$PREFIX/share/proof-of-work/`
| Data files, assets

| `$PREFIX/share/doc/proof-of-work/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/proof-of-work/config.toml`

Fallback: `$HOME/.config/proof-of-work/config.toml`
...
Or via OPSM: `opsm update proof-of-work`
...
[source,bash]
----
just install --prefix=/opt/proof-of-work-instance1 --config=/etc/proof-of-work/instance1.toml
just install --prefix=/opt/proof-of-work-instance2 --config=/etc/proof-of-work/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/proof-of-work/issues
