...
*A puzzle game where solutions are cryptographically verified — prove
your work, literally.*

=== What Is It?

Proof of Work is a logic puzzle game built with
https://bevyengine.org/[Bevy] where players solve constraint-based
puzzles. What makes it unique: every solution is verified using the
https://github.com/Z3Prover/z3[Z3 SMT solver], producing a mathematical
certificate that the solution is correct.
...
|===
|Feature |Description
|*Z3 Verification* |Solutions verified by SMT solver, exported as
SMT-LIB2
...
[arabic]
. Player places logic pieces on the puzzle grid
. Board connections are checked for validity
. Z3 encodes the puzzle constraints as SMT-LIB2 formulas
. Solver proves satisfiability — the solution is mathematically correct
. Proof is exported and optionally submitted to the leaderboard
...
* https://github.com/hyperpolymath/proof-of-work[Source Code]
* https://github.com/hyperpolymath/proof-of-work/issues[Issue Tracker]
