...
// Replace proof-of-work, Proof Of Work — See README.adoc for details., just run, Proof Of Work started successfully. with actuals
= proof-of-work — Quick Start for Users
:toc:
:toclevels: 2

== What is proof-of-work?

Proof Of Work — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./proof-of-work-portable
----
...
[source]
----
Proof Of Work started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/proof-of-work/wiki
